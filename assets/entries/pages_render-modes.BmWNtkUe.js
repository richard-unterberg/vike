import{o as d,a as o}from"../chunks/chunk-D7W6cz9L.js";import{j as e,b as s}from"../chunks/chunk-CDJGqYdM.js";import{L as r}from"../chunks/chunk-B92MPKY5.js";/* empty css                      */import{W as c}from"../chunks/chunk-vvmahyUt.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as t}from"../chunks/chunk-CqCXRXff.js";import{U as h}from"../chunks/chunk-SNlRTpmO.js";/* empty css                      *//* empty css                      */import{M as p}from"../chunks/chunk-N9fe3xIW.js";/* empty css                      *//* empty css                      */import"../chunks/chunk-ClcFzDq1.js";import"../chunks/chunk-CEgeoNWL.js";const x=[{pageSectionId:"spa",pageSectionLevel:2,pageSectionTitle:"SPA"},{pageSectionId:"ssr",pageSectionLevel:2,pageSectionTitle:"SSR"},{pageSectionId:"pre-rendering-ssg",pageSectionLevel:2,pageSectionTitle:"Pre-rendering (SSG)"},{pageSectionId:"html-only",pageSectionLevel:2,pageSectionTitle:"HTML-only"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(a){const n={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t(),...a.components},{CodeSnippets:l}=n;return l||y("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(p,{children:e.jsxs(n.p,{children:["This page documents how to implement render modes yourself. It's an advanced task and we generally recommend simply using the ",e.jsx(r,{href:"/ssr",children:e.jsx(n.code,{children:"ssr"})})," and ",e.jsx(r,{href:"/pre-rendering#get-started",children:e.jsx(n.code,{children:"prerender"})})," settings instead."]})}),`
...
`,e.jsxs(n.p,{children:['What "SPA", "SSR", "HTML-only" and "SSG" mean, and which one should be used, is explained at ',e.jsx(r,{href:"/SSR-vs-SPA"}),"."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`,e.jsxs(n.li,{children:["We set ",e.jsx(n.code,{children:"Page"}),"'s ",e.jsx(r,{href:"/meta",children:"meta config"})," ",e.jsx(n.code,{children:"env"})," to ",e.jsx(n.code,{children:"{ server: false, client: true }"})," instead of ",e.jsx(n.code,{children:"{ server: true, client: true }"}),"."]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})})]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["See ",e.jsx(r,{href:"/hydration"}),' for understanding the difference between "rendering to the DOM" and "hydrating the DOM".']}),`
`]}),`
...
`,e.jsxs(n.p,{children:["For production, we usually want to ",e.jsx(r,{text:"pre-render",href:"/pre-rendering"})," the HTML of our SPA pages in order to remove the need for a production Node.js server."]}),`
...
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"}"})})]})})})]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"pageContext.config.title"})," and ",e.jsx(n.code,{children:"pageContext.config.description"})," are custom settings, see ",e.jsx(r,{href:"/meta#example-title-and-description",doNotInferSectionTitle:!0}),"."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["If we want to have both SSR and SPA pages, then see ",e.jsx(r,{href:"#spa",children:"the SPA section"}),"."]}),`
...
`,e.jsx(c,{children:"Using modern UI frameworks (React/Vue/...) to render pages only to HTML is a novel technique and should be considered experimental."}),`
`,e.jsx(n.p,{children:"To render a page to HTML-only:"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["We set ",e.jsx(n.code,{children:"Page"}),"'s ",e.jsx(r,{href:"/meta",children:"meta config"})," ",e.jsx(n.code,{children:"env"})," to ",e.jsx(n.code,{children:"{ server: true, client: false }"})," instead of ",e.jsx(n.code,{children:"{ server: true, client: true }"}),"."]}),`
`,e.jsxs(n.li,{children:["(Optional) We define ",e.jsx(r,{href:"/client",children:e.jsx(n.code,{children:"+client.js"})})," (e.g. to add a minimal amount of JavaScript surgically injecting bits of interactivity)."]}),`
`]}),`
`,e.jsxs(l,{children:[e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// /renderer/+config.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// Environment: config"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
