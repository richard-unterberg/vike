import{o as i,a as o}from"../chunks/chunk-D7W6cz9L.js";import{j as e}from"../chunks/chunk-CDJGqYdM.js";import{L as l}from"../chunks/chunk-B92MPKY5.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as a}from"../chunks/chunk-CqCXRXff.js";import{V as c}from"../chunks/chunk-CZgvVegx.js";/* empty css                      */import{C as d}from"../chunks/chunk-A43jm3L3.js";/* empty css                      */import"../chunks/chunk-ClcFzDq1.js";/* empty css                      */const h=[{pageSectionId:"override-for-individual-links",pageSectionLevel:2,pageSectionTitle:"Override for individual links"},{pageSectionId:"programmatic-prefetch",pageSectionLevel:2,pageSectionTitle:"Programmatic `prefetch()`"},{pageSectionId:"different-settings-for-mobile-desktop",pageSectionLevel:2,pageSectionTitle:"Different settings for mobile/desktop"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(n){const s={a:"a",blockquote:"blockquote",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...a(),...n.components},{CodeSnippets:t}=s;return t||x("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(d,{env:"client",default:e.jsx(s.code,{children:"'hover'"}),isTypeOneLiner:!0,children:e.jsx(s.p,{children:e.jsx(s.span,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.code,{"data-language":"ts","data-theme":"github-light",children:e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#005CC5"},children:"false"}),e.jsx(s.span,{style:{color:"#D73A49"},children:" |"}),e.jsx(s.span,{style:{color:"#032F62"},children:" 'hover'"}),e.jsx(s.span,{style:{color:"#D73A49"},children:" |"}),e.jsx(s.span,{style:{color:"#032F62"},children:" 'viewport'"}),e.jsx(s.span,{style:{color:"#24292E"},children:" "})]})})})})}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"  prefetchStaticAssets: "}),e.jsx(s.span,{style:{color:"#032F62"},children:"'hover'"}),e.jsx(s.span,{style:{color:"#24292E"},children:","})]}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
...
`,e.jsxs(s.p,{children:["Viewport prefetching is disabled in development. (Because preloading pages that early ",e.jsx(c,{}),".)"]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"prefetchStaticAssets"})," setting requires ",e.jsx(l,{href:"/client-routing",children:"Client Routing"}),"."]}),`
`]}),`
...
`,e.jsxs(s.p,{children:["You can programmatically call ",e.jsx("code",{children:"prefetch('/some/url')"}),", see ",e.jsx(l,{href:"/prefetch"}),"."]}),`
...
`,e.jsxs(t,{children:[e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/+prefetchStaticAssets.js"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"export"}),e.jsx(s.span,{style:{color:"#D73A49"},children:" const"}),e.jsx(s.span,{style:{color:"#005CC5"},children:" prefetchStaticAssets"}),e.jsx(s.span,{style:{color:"#D73A49"},children:" ="}),e.jsx(s.span,{style:{color:"#24292E"},children:" window."}),e.jsx(s.span,{style:{color:"#6F42C1"},children:"matchMedia"}),e.jsx(s.span,{style:{color:"#24292E"},children:"("}),e.jsx(s.span,{style:{color:"#032F62"},children:"'(max-width: 600px)'"}),e.jsx(s.span,{style:{color:"#24292E"},children:").matches"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"  ?"}),e.jsx(s.span,{style:{color:"#032F62"},children:" 'viewport'"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"  :"}),e.jsx(s.span,{style:{color:"#032F62"},children:" 'hover'"})]})]})})}),e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{tabIndex:"0","data-language":"ts","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"ts","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/+prefetchStaticAssets.ts"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// For small screens, such as mobile, viewport prefetching can be a sensible strategy"})}),`
...
`,e.jsxs(s.p,{children:["(Don't define it inside a ",e.jsx(s.code,{children:"+config.js"})," file because ",e.jsx(s.code,{children:"window.matchMedia()"})," only exists in the browser and it would ",e.jsxs(l,{href:"/config#pointer-imports",children:["prevent Vike from loading ",e.jsx(s.code,{children:"+config.js"})," files"]}),".)"]}),`
`]}),`
...
`]}),`
`]})]})}function p(n={}){const{wrapper:s}={...a(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(r,{...n})}):r(n)}function x(n,s){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const j=Object.freeze(Object.defineProperty({__proto__:null,default:p,pageSectionsExport:h},Symbol.toStringTag,{value:"Module"})),M={hasServerOnlyHook:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!1}},isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:o}},onCreatePageContext:{type:"cumulative",definedAtData:[{filePathToShowToUser:"@brillout/docpress/renderer/onCreatePageContext",fileExportPathToShowToUser:[]}],valueSerialized:[{type:"pointer-import",value:i}]},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/prefetchStaticAssets/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:j}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}}};export{M as configValuesSerialized};
