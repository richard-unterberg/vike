...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["For a quick start, you can use ",e.jsx(i,{href:"/vike-server",children:e.jsx(n.code,{children:"vike-server"})})," instead of manually integrating ",e.jsx(n.code,{children:"renderPage()"}),"."]}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
