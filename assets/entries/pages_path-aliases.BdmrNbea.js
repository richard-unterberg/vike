import{o,a as t}from"../chunks/chunk-D7W6cz9L.js";import{j as e}from"../chunks/chunk-CDJGqYdM.js";import{L as n}from"../chunks/chunk-B92MPKY5.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as a}from"../chunks/chunk-CqCXRXff.js";/* empty css                      */const d=[{pageSectionId:"vite-config-js",pageSectionLevel:2,pageSectionTitle:"`vite.config.js`"},{pageSectionId:"tsconfig-json",pageSectionLevel:2,pageSectionTitle:"`tsconfig.json`"},{pageSectionId:"package-json",pageSectionLevel:2,pageSectionTitle:"`package.json`"},{pageSectionId:"config-files",pageSectionLevel:2,pageSectionTitle:"Config files"}];function r(i){const s={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...i.components},{CodeSnippets:l}=s;return l||h("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Instead of using relative import paths, which can be cumbersome, you can use path aliases. For example:"}),`
...
`]}),`
`]}),`
`,e.jsxs(s.p,{children:["If you use a custom server integration (",e.jsxs(s.strong,{children:["you don't use ",e.jsx(s.code,{children:"vike-server"})]}),"), also define them at:"]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
...
`,e.jsxs(s.li,{children:["Your server code if you use ",e.jsx(n,{href:"/vike-server",children:e.jsx(s.code,{children:"vike-server"})}),"."]}),`
`]}),`
...
`,e.jsxs(s.p,{children:["If you use a JavaScript server, with a ",e.jsx(n,{href:"/server-integration#manual-integration",children:"custom integration"})," instead of using ",e.jsx(n,{href:"/vike-server",children:e.jsx(s.code,{children:"vike-server"})}),", then also define your path aliases at:"]}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(n,{href:"/vike-server",children:e.jsx(s.code,{children:"vike-server"})}),", all your server code is transpiled by Vite. Defining path aliases at ",e.jsx(s.code,{children:"vite.config.js"})," is enough because Vite already resolves all path aliases and Node.js doesn't see any path alias."]}),`
`,e.jsxs(s.p,{children:["If you don't use ",e.jsx(s.code,{children:"vike-server"}),", your server code isn't processed by ",e.jsx(s.a,{href:"https://vite.dev",children:"Vite"})," out of the box. Instead, Node.js directly executes your server code and, therefore, you must configure Node.js to resolve your path aliases. See also: ",e.jsx(s.a,{href:"https://github.com/vikejs/vike/issues/562",children:"#562 - Transpile server code"}),"."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
