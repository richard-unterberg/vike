...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["These are actually Vike settings, which alias Vite settings. (See ",e.jsx(s,{href:"/host",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/mode",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/port",noBreadcrumb:!0}),"/",e.jsx(s,{href:"/force",noBreadcrumb:!0}),".) In other words: each Vike CLI option corresponds to a ",e.jsx(s,{href:"/settings",children:"Vike setting"}),"."]}),`
`,e.jsx(n.p,{children:"Reach out if you believe there are other Vite settings that should also be aliased."}),`
`]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["For example ",e.jsx(n.code,{children:"{someProp:'someVal'}"}),", which isn't valid ",e.jsx(n.code,{children:"JSON"}),", is valid JSON5."]}),`
`]}),`
`]}),`
