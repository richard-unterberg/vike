...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"pageContext.runtime"})," object is the ",e.jsx(n.a,{href:"https://universal-middleware.dev/reference/runtime-adapter",children:e.jsx(n.code,{children:"RuntimeAdapter"})})," and it contains:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"pageContext.runtime.req"})," — the original HTTP request object, for example ",e.jsx(n.a,{href:"https://nodejs.org/api/http.html#class-httpincomingmessage",children:"IncomingMessage"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"pageContext.runtime.res"})," — the original HTTP response object, for example ",e.jsx(n.a,{href:"https://nodejs.org/api/http.html#class-httpserverresponse",children:"ServerResponse"}),"."]}),`
`]}),`
`,e.jsxs(n.p,{children:["It's set by ",e.jsx(s,{href:"/vike-server",children:e.jsx(n.code,{children:"vike-server"})})," (which uses ",e.jsx(n.a,{href:"https://universal-middleware.dev/",children:e.jsx(n.code,{children:"universal-middleware"})})," under the hood)."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["It's only available if you use ",e.jsx(n.code,{children:"vike-server"}),"."]}),`
`]}),`
`,e.jsx(l,{name:"config"}),`
...
`,e.jsxs(n.p,{children:["If you don't use ",e.jsx(s,{href:"/vike-server",children:e.jsx(n.code,{children:"vike-server"})}),", then you can define custom properties at ",e.jsx(s,{href:"/renderPage",children:e.jsx(n.code,{children:"renderPage()"})}),":"]}),`
...
`]}),`
`]})]})}function p(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}function x(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const j=Object.freeze(Object.defineProperty({__proto__:null,default:p,pageSectionsExport:h},Symbol.toStringTag,{value:"Module"})),R={hasServerOnlyHook:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!1}},isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:c}},onCreatePageContext:{type:"cumulative",definedAtData:[{filePathToShowToUser:"@brillout/docpress/renderer/onCreatePageContext",fileExportPathToShowToUser:[]}],valueSerialized:[{type:"pointer-import",value:o}]},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/pageContext/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:j}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}}};export{R as configValuesSerialized};
