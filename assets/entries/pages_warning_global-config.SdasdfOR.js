import{o,a as d}from"../chunks/chunk-D7W6cz9L.js";import{j as e}from"../chunks/chunk-CDJGqYdM.js";import{L as s}from"../chunks/chunk-B92MPKY5.js";/* empty css                      *//* empty css                      */import{C as i}from"../chunks/chunk-O9rbDScJ.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as r}from"../chunks/chunk-CqCXRXff.js";/* empty css                      *//* empty css                      */const c=[{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(l){const n={blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...r(),...l.components},{CodeSnippets:a}=n;return a||h("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["A config is called ",e.jsx(n.em,{children:"global"})," when it always applies to all pages (it cannot be applied to only a subset of pages)."]}),`
`,e.jsxs(n.p,{children:["For example, ",e.jsx(s,{href:"/base-url",children:"the Base URL settings"})," are global: changing the Base URL affects your whole app (all your pages)."]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["There isn't any ",e.jsx(s,{href:"/config#inheritance",children:"config inheritance"})," for global configs."]}),`
`]}),`
