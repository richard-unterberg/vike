import{o as d,a as c}from"../chunks/chunk-D7W6cz9L.js";import{j as e,b as i}from"../chunks/chunk-CDJGqYdM.js";import{L as s}from"../chunks/chunk-B92MPKY5.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as o}from"../chunks/chunk-CqCXRXff.js";import{U as r}from"../chunks/chunk-ClcFzDq1.js";import{U as h}from"../chunks/chunk-SNlRTpmO.js";/* empty css                      */import{C as p}from"../chunks/chunk-A43jm3L3.js";/* empty css                      */import"../chunks/chunk-CEgeoNWL.js";/* empty css                      */const x=[{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"getting-started",pageSectionLevel:2,pageSectionTitle:"Getting started"},{pageSectionId:"links-intercepting",pageSectionLevel:2,pageSectionTitle:"Links intercepting"},{pageSectionId:"hooks",pageSectionLevel:2,pageSectionTitle:"Hooks"},{pageSectionId:"settings",pageSectionLevel:2,pageSectionTitle:"Settings"},{pageSectionId:"programmatic-navigation",pageSectionLevel:2,pageSectionTitle:"Programmatic navigation"},{pageSectionId:"state-initialization",pageSectionLevel:2,pageSectionTitle:"State initialization"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(l){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",figure:"figure",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",ul:"ul",...o(),...l.components},{CodeSnippets:a}=n;return a||y("CodeSnippets"),e.jsxs(e.Fragment,{children:[e.jsx(p,{env:"client",global:!0,isTypeOneLiner:!0,default:e.jsxs(e.Fragment,{children:[e.jsx(n.code,{children:"false"})," (but ",e.jsx(n.code,{children:"true"})," if you use ",e.jsx(r,{succinct:!0}),")"]}),children:e.jsx(n.p,{children:e.jsx(n.span,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.code,{"data-language":"ts","data-theme":"github-light",children:e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"boolean "})})})})})}),`
`,e.jsxs(n.p,{children:["If you don't use a ",e.jsx(r,{})," then Vike does ",e.jsx(s,{text:"Server Routing",href:"/server-routing"})," by default."]}),`
...
`,e.jsx(i,{path:"/packages/create-vike-core/boilerplate-react-ts/renderer/+onRenderClient.tsx"}),`
`]}),`
`]}),`
`,e.jsx(n.p,{children:"Vue example:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsx(i,{path:"/packages/create-vike-core/boilerplate-vue-ts/renderer/+onRenderClient.ts"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(i,{path:"/packages/create-vike-core/boilerplate-vue-ts/renderer/app.ts"}),`
`]}),`
`]}),`
